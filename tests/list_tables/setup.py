...
def setup(host, keystone_url, user, password, domain_name, project_name):
    ...
    table_3_fields_1_lsi_list = []
    table_10_fields_5_lsi_list = []
    count_table_3_fields_no_lsi = cfg.TABLES_CREATED_3_FIELDS_NO_LSI
    count_table_3_fields_1_lsi = cfg.TABLES_CREATED_3_FIELDS_1_LSI
    count_table_10_fields_5_lsi = cfg.TABLES_CREATED_10_FIELDS_5_LSI
